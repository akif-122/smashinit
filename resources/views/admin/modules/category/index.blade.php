    ...
    <div class="col-12">
        <div class="card">
            <div class="border-bottom title-part-padding">
                ...
                <a href="{{route('admin.category.create')}}" style="float:right;"><button class="btn btn-success">Add New Category</button></a>
            </div>
            <div class="card-body">
                    ...
                    <table id="multi_col_order" class="table table-bordered display"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href=""><button class="btn btn-xs btn-success">Items</button></td>
                                ...
                                <td>
                                    <a href="{{route('admin.category.edit',['id' => $key->id])}}"><button class="btn btn-xs btn-warning">Edit</button></a>

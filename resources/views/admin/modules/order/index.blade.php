                ...
                <div class="table-responsive">
                    <table id="multi_col_order" class="table table-bordered display"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$count++}}</td>
                                <td>{{$order->user->name}} <br> {{$order->user->email}} <br> {{$order->user->phone}}</td>
                                <td>{{$order->order_number}}</td>
                                <td>
                                    <div class="mb-1">
                                        Order Price: &pound{{ number_format($order->total, 2) }}

                                    </div>
                                    <div class="mb-1">
                                        Shipping: &pound{{ number_format($order->shipping_price, 2) }}

                                    </div>
                                    <div class="mb-1">
                                        Total Price: &pound{{ number_format($order->total_price, 2) }}
